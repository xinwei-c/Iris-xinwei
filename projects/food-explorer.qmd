...
image: "img/food-explorer.png" 

description: "The visualization is part of my course work where I build interactive relationship between variables. The work is build with Shiny package. "


categories: ["Data Visualization", "R"] 
---

![Main visualization](img/food-explorer.png)
...
The full interactive application is hosted on ShinyApps: [**Launch Cuisine Explorer App**](https://xinwei.shinyapps.io/cuisine_explorer/)
:::
